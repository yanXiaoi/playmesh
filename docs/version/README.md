...
- 当前正式发行：App `4.1.0+27`、Game SDK `4.0.0`、App Bridge SDK `3.2.0`、
  Go Core `0.5.0`、Core 协议 `1.3.0`、Catalog API `3.0.0`、Relay 协议 `3.0.0`、
  Developer API `4.1.0`、Developer CLI `2.0.0`
- 当前版本详细日志：`docs/version/4.1.0.md`
- 最新正式发行详细日志：`docs/version/4.1.0.md`
