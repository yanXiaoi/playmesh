...
开发版本为 Playmesh `3.1.0+24`、Go Core `0.5.0`、Core 协议 `1.3.0`、Game SDK
`3.1.0`、App Bridge SDK `3.0.0`、Catalog API `2.0.0`、Relay 协议 `2.0.0`、
Developer API / OpenAPI `2.3.0`、Developer CLI `1.4.0`；两套 SDK 已收敛为 Dart
