...
| 版本 | 文档 | 范围 |
| --- | --- | --- |
| Playmesh `4.2.1+29` | [4.2.1 正式版本日志](../version/4.2.1.md) · [手动检查 App 更新](playmesh-4.2.0-app-update.md) · [局域网发现与分享](playmesh-4.2.0-lan-game-discovery.md) | 安装包导出响应式重构、Runtime SHA 更新提示、GDevelop 首页排版与 WebView capability 刷新恢复 |
