...
class Webview {
 public:
  ...
  typedef std::function<void(WebviewExternalNavigationRequest)>
      ExternalNavigationRequestedCallback;
  ...
  void OnExternalNavigationRequested(
      ExternalNavigationRequestedCallback callback) {
    external_navigation_requested_callback_ = std::move(callback);
  }
 ...
 private:
  ...
  ExternalNavigationRequestedCallback external_navigation_requested_callback_;
